...
class PageModalAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        if ($this->customIcon !== null) {
            parent::icon($this->customIcon);
        }
        if ($this->customColor !== null) {
            parent::color($this->customColor);
        }
        if ($this->customModalHeading !== null) {
            parent::modalHeading($this->customModalHeading);
        }
        if ($this->customModalDescription !== null) {
            parent::modalDescription($this->customModalDescription);
        }
